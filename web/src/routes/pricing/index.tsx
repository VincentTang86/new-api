...
// Only `model` and `type` are read by the page — the filter params below are
// inert here, but the schema stays because other features still deep-link with
// them (features/rankings/components/entity-links.tsx, features/dashboard's
// overview dashboard), and dropping it would make those links throw on
// navigation.
