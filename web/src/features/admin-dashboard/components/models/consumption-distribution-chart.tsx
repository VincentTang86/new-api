...
import { CONSUMPTION_DISTRIBUTION_CHART_OPTIONS } from '@/features/admin-dashboard/constants'
import { processChartData } from '@/features/admin-dashboard/lib'
import type {
...
export function ConsumptionDistributionChart(
  ...
  const [chartType, setChartType] =
    useState<ConsumptionDistributionChartType>('bar')
