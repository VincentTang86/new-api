...
export function UserCharts(props: UserChartsProps) {
  ...
  // The selections are owned by the page so they survive switching tabs; the
  // window itself comes from the page-level range picker.
  ...
  const handleGranularityChange = useCallback(
    (g: TimeGranularity) => {
      onFiltersChange({ ...props.filters, timeGranularity: g })
    },
