  ...
  if (variant === 'inline') {
    return (
      <Link
        ...
        className={cn(
          'text-foreground inline-flex h-9 items-center gap-3 rounded-md px-1.5 transition-colors outline-none select-none',
      ...
      >
        ...
        <span className='console-brand-name max-w-[12rem] truncate text-[22px] font-bold'>
          {name}
        </span>
      </Link>
    )
