...
func normalizeOpenAIUsage(usage *dto.Usage) {
	...
	if usage.OutputTokensDetails != nil {
		// gpt-image models report the image/text split of output_tokens here;
		// CompletionTokenDetails.ImageTokens feeds the img_o billing variable and
		// the image_output_tokens log detail.
