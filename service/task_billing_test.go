...
func TestRecalculate_PositiveDelta(t *testing.T) {
	...
	RecalculateTaskQuota(ctx, task, actualQuota, upstreamTokens, "adaptor adjustment")
	...
	// 差额日志记的是上游回传的真实用量，对账看的就是这个数
	assert.Equal(t, upstreamTokens, log.CompletionTokens)
}
